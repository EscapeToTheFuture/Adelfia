...
const Win = ({reason}) => {
    ...
    return (
        <div className="flex flex-col items-center justify-center h-screen bg-[url(../images/Piazza.png)] bg-center bg-clip-border bg-cover bg-origin-border bg-no-repeat">
            <div className="backdrop-brightness-20 h-full w-full flex flex-col items-center justify-evenly">
                ...
                <h2 className="font-elite text-3xl md:text-3xl xl:text-4xl z-1 text-white select-none w-300 text-center">Hai salvato la città di Adelfia</h2>
                <Button
                    onClick={async () => {
                        navigate("/")
                    }}
